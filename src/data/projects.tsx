...
const projects: Project[] = [
  ...
  { // 01. AI Docker file optimizer project
    ...
    github:"https://github.com/prajuz2411/AI-Docker-file-optimizer",
    skills: {
  ...
  { // 02. FinanceMe project
    ...
    live: "https://github.com/prajuz2411/FinanceMe-Devops-Project-01",
    github: "https://github.com/prajuz2411/FinanceMe-Devops-Project-01",
    get content() {
      return (
        <div>
          <TypographyP className="font-mono text-2xl text-center">
  ...
  { // 03. Portfolio project
    ...
    live: "https://www.prajwalbobade.com/",
    github:"https://github.com/prajuz2411/3D-interactive-portfolio",
    skills: {
      frontend: [
        PROJECT_SKILLS.ts,
        PROJECT_SKILLS.next,
  ...
  { // 04. Smart parking assitant
    ...
    live: "https://github.com/prajuz2411/smart-parking-assistant",
    github:"https://github.com/prajuz2411/smart-parking-assistant",
    skills: {
  ...
  { // 05. Smart Job Tracker project
    ...
    github:"https://github.com/prajuz2411/Job-tracker-application",
    skills: {
      frontend: [PROJECT_SKILLS.js, PROJECT_SKILLS.next, PROJECT_SKILLS.tailwind, PROJECT_SKILLS.vite],
  ...
  { // 06. Savinder Puri portfolio project
    ...
    github:"https://github.com/prajuz2411/savinder-puri",
    skills: {
      frontend: [PROJECT_SKILLS.js, PROJECT_SKILLS.next, PROJECT_SKILLS.tailwind, PROJECT_SKILLS.vite],
      backend: [],
    },
      ...
      return (
        <div>
          <TypographyP className="font-mono ">
            ...
            transforms lives. 💻🕊️ Crafted with ❤️ by Prajwal Bobade! 🚀
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <SlideShow
            images={[
