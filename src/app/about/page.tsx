...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "prajwalbobade75@gmail",
    href: "mailto:prajwalbobade@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/prajwal-bobade-061104245",
    content: "/bobade-prajwal",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/prajuz2411",
...
const TOOLS = [
  ...
  },
  {
    name: "VS Code",
    content: "Next.js is a React framework for production",
    icon: <BiLogoVisualStudio size={"50px"} color="#007acc" />,
    color: "#007acc",
  },
  {
    name: "VIM",
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m prajwal, a Comp. Sci. Engineer with 1.5 year experience in Devlopment, DevOps and 
